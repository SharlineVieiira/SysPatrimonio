...
namespace SysPatrimonio.Controllers
{
    public class PatrimoniosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,numeetiqueta,nomepatrimonio,descricaopatrimonio,valorpatrimonio,idcategoria,idlocal,iddepartamento,marcamodelo,dataaquisicao,databaixa,numnf,numserie,situacao,idfornecedor,datagarantia")] DbPatrimonio dbPatrimonio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,numeetiqueta,nomepatrimonio,descricaopatrimonio,valorpatrimonio,idcategoria,idlocal,iddepartamento,marcamodelo,dataaquisicao,databaixa,numnf,numserie,situacao,idfornecedor,datagarantia")] DbPatrimonio dbPatrimonio)
        {
